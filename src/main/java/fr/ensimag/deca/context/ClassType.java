...
public class ClassType extends Type {
    ...
    public boolean isSubClassOf(ClassType potentialSuperClass) {
    	if(this.getName() == potentialSuperClass.getName()) {
    			return true;
    		}
    		else {
    			ClassDefinition classDef = this.getDefinition();
    			if(classDef.getSuperClass() != null) {
       				return classDef.getSuperClass().getType().isSubClassOf(potentialSuperClass);    				
    			}
   			}
       	return false;    		
    }
