...
public abstract class AbstractDeclClass extends Tree {
	...
	public abstract String getClassName();
        ...
        public abstract int buildMethodTableIMA(DecacCompiler compiler, int nextOffset);
        
	public abstract int buildMethodTableGBA(DecacCompiler compiler, int nextOffset);
	
	public abstract void codeGenClassIMA(DecacCompiler compiler);
	
	public abstract void codeGenClassGBA(DecacCompiler compiler);
	
        public abstract void codeGenInitIMA(DecacCompiler compiler);
        
	public abstract void codeGenInitGBA(DecacCompiler compiler);
