...
public class Plus extends AbstractOpArith {
    ...
    protected VirtualDVal codeGenExprIMA(DecacCompiler compiler) {
    	...
    	compiler.addInstruction(new ADD(operands.getROperand().getDVal(compiler, true), lRegister));
    ...
    protected VirtualDVal codeGenExprGBA(DecacCompiler compiler) {
    	...
    	compiler.addInstruction(new GADD(lRegister, lRegister, new GOp2(operands.getROperand().getDVal(compiler, true))));
