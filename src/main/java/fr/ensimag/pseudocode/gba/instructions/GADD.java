...
public class GADD extends GTernaryInstructionRdRnOp2 {

	public GADD(Register rd, Register rn, GOp2 op, GCondition cond, boolean updateCPSR) {
		super(rd, rn, op, cond, updateCPSR);
	}
	
	public GADD(Register rd, Register rn, GOp2 op) {
